...
class mumongo
{
    ...
    /**
     * 更新数据
     * @param array $where 更新条件 array("firstname" => "Bob")
     * @param array $update 更新内容 array("address" => "1 Smith Lane")
     */
     ...
     * 删除记录
     * Enter description here ...
     * @param array $where array("firstname" => "Bob")
     * @param boolean $justOne boolen
     */
    ...
    /**
     * 设置索引
     * @param array $aIdex 索引字段 array('uid' => 1) 1升序  -1降序
     * @param array $options 索引类型  array('unique' => 1) 唯一索引
     */
    ...
    /**
     * 批量获取符合条件的记录
     * @param array $where 条件数组格式  如 array('uid' => 55)
     * @param array $field 需要返回的字段  如 array('uid' => 55)
     * @param int $offset 起始位置
     * @param int $lengths 返回记录数
     * @param boolean $isCount 是否返回总记录数
     */
    ...
    private function errorlog($msg)
    {
        ...
        \lib\Log::dayLog($error,"mongondb.txt");
    }
}